...
@Component({
  selector: 'app-cascaded-select-using-observable',
  templateUrl: './cascaded-select-using-observable.component.html',
  styles: [
  ]
})
export class CascadedSelectUsingObservableComponent {

  form = new FormGroup({});
  model: Partial<any> = { sport: '1' };
